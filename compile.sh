...
echo $"Usage: source $0 android-abi-level arm-arch{6|6-nofpu|7}"
esac
case $2 in
6)
...
export ARCH_LINK="-march=armv6 -flto -Wl,--gc-sections -L$BASEDIR/armv6-nofpu_lib -I$BASEDIR/armv6-nofpu_inc"
;;
7)
